...
export default function PracticeReport({ onComplete }: { onComplete: () => void }) {
  ...
  return <section className="practice mock-report" id="practice">
    ...
    <div className="practice-case"><strong>Your practice case</strong><p>27 April, wet weather: a student slips on the walkway beside Block 73 and has a minor injury. You check on them, keep others clear and arrange first-aid support.</p><span>Use these case details. No names or personal contact details needed.</span></div>
